...
- Every substantive paragraph must reference a selected claim and an associated excerpt. Quoted strings are checked against the frozen evidence and source text; unknown references, invented quotation strings and unsupported reference indices are rejected.
